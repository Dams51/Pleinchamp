...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    if not entry.options:
        ...
        for conf_key, default in [
            ...
            (CONF_CONDITION_CLOUDCOVER_HIGH_WEAKENING, DEFAULT_CONDITION_CLOUDCOVER_HIGH_WEAKENING),
            (CONF_CONDITION_CLOUDCOVER_MEDIUM_WEAKENING, DEFAULT_CONDITION_CLOUDCOVER_MEDIUM_WEAKENING),
            (CONF_CONDITION_CLOUDCOVER_LOW_WEAKENING, DEFAULT_CONDITION_CLOUDCOVER_LOW_WEAKENING),
            (CONF_CONDITION_FOG_WEIGHT, DEFAULT_CONDITION_FOG_WEIGHT),
            (CONF_CONDITION_SEEING_WEIGHT, DEFAULT_CONDITION_SEEING_WEIGHT),
            (CONF_CONDITION_TRANSPARENCY_WEIGHT, DEFAULT_CONDITION_TRANSPARENCY_WEIGHT),
    ...
    forecast_coordinator = DataUpdateCoordinator(
        ...
        update_method=pleinchamp.get_forecast_data,
        update_interval=timedelta(minutes=entry.options.get(CONF_FORECAST_INTERVAL, DEFAULT_FORECAST_INTERVAL)),
    )
